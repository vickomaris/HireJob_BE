...
## About The Project
This is a Back-End Hirejobs. This is built using Express JS and PostgreSQL.
...
<ul id='build-with'>
  ...
  <li><a href='https://github.com/vickomaris/HireJob_BE/blob/master/package.json'>and you can see the dependencies used in the package.json</a></li>
</ul>
